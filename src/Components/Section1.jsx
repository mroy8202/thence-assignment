...
const Section1 = () => {
    return (
        <div className='w-full flex flex-col gap-16 items-center pl-8'>
            ...
            <div className='w-full flex flex-wrap justify-center gap-2'>
                <div className='relative flex justify-center items-center'>
                    <img src={Girl} alt='img' className='rounded-3xl h-[450px] w-[420px] -z-10' />
                    <div className='absolute top-16 right-72  z-10'>
                        <div className='h-48 w-52 bg-white rounded-2xl relative'>
                            <img src={Spark} alt='img' className='absolute -top-7 -left-5' />
                    ...
                    <div className='flex gap-4 p-4 bg-white rounded-full absolute bottom-10 -left-16'>
